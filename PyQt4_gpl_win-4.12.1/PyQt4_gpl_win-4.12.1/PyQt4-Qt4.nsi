...
!define PYQT_ARCH           "64"
!define PYQT_QT_VERS        "4.8.7"
!define PYQT_QT_DOC_VERS    "4.8"
...
Section "Qt runtime" SecQt
    ...
    SetOutPath $INSTDIR\Lib\site-packages\PyQt4\plugins\accessible
    File "${QT_SRC_DIR}\plugins\accessible\qtaccessiblewidgets4.dll"

    SetOutPath $INSTDIR\Lib\site-packages\PyQt4\plugins\bearer
    File "${QT_SRC_DIR}\plugins\bearer\qgenericbearer4.dll"
    File "${QT_SRC_DIR}\plugins\bearer\qnativewifibearer4.dll"
    ...
    File "${QT_SRC_DIR}\plugins\imageformats\qtga4.dll"
